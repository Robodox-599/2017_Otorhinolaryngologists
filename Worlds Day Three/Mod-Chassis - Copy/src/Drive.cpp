...
{
	//Left Drive
	frontLeftDrive = new CANTalon(3);
	backLeftDrive = new CANTalon(4);
...
void Drive::updateAllMotors()
{
	...
	SmartDashboard::PutNumber("Left Offset", leftOffset);
	SmartDashboard::PutNumber("Right Offset", rightOffset);*/
...
void Drive::updateLeftMotors(float speed)
{
	...
	//SmartDashboard::PutNumber("FLVoltage", frontLeftDrive->);
}
