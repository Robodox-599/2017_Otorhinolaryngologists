...
public:
	...
	*/
	...
	void AutonomousPeriodic()
	{
		...
		//auton->middleGear();
		auton->gearSide(-55);//was 60 -> 58 ->54
		//auton->boilerSide(53);//50
	...
	void encVals()
	{
		...
		SmartDashboard::PutNumber("enc velocity left", drive->getCANTalonLeft()->GetEncVel());
		SmartDashboard::PutNumber("enc velocity right", drive->getCANTalon()->GetEncVel());
	}
