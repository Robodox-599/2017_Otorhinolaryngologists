...
void Autonomous::vtBoilerSide(float side)
{
	if(autoSteps == 0)
	{
		gyroDrive->straightDrive();
		isDriving = encDrive->setDistance(86);//was 99.9
	...
	{
		time->Start();
		if(time->HasPeriodPassed(.5))//was .5
		{
			timerReset();
			encDrive->reset();
			gyroDrive->reset();
	...
	if(autoSteps == 3)
	{
		...
		if(!pxyDrive->trackTurn() && encDrive->distanceError() > 24)
		{
			gyroDrive->reset();
		}
		else
...
//Middle Gear
//With pixy correction
void Autonomous::vtMiddleGear(float side)
{
	if(autoSteps == 0)
	{
		time->Start();
		...
		isDriving = encDrive->setDistance(74);//78 -> 81 -> 83
...
void Autonomous::boilerSide(int side)
{
	...
	{
		gyroDrive->straightDrive();
		isDriving = encDrive->setDistance(104);//was 99.9
	...
	if(autoSteps == 3)
	{
		...
		gyroDrive->straightDrive();
		isDriving = encDrive->setDistance(45);//33.1
...
void Autonomous::middleGear()
{
	...
	if(autoSteps == 0)
	{
		...
		isDriving = encDrive->setDistance(87);//78 -> 81 -> 83
...
void Autonomous::gearSide(int side)
{
	...
	{
		gyroDrive->straightDrive();
		isDriving = encDrive->setDistance(115);//was 99.9
	...
	if(autoSteps == 3)
	{
		...
		gyroDrive->straightDrive();
		isDriving = encDrive->setDistance(50);//33.1
