...
void Autonomous::auto3()
{
	...
	else if(autoSteps == 2)
	{
		...
		gyroDrive->straightDrive();//find a different solution to this

		if(time->HasPeriodPassed(2))//isDriving ||
		{
			...
			encDrive->reset();//try taking this out
			isDriving = false;
...
/*void Autonomous::basicAuto1()
{
	while(drive->getCANTalon()->GetEncPosition() < )
	{
